...
<body>
    ...
    ?>
    <div class="seccao">
        <form action="nova_marcacao.php">
            <input type="submit" value = "Nova Marcação">
        </form>
            ...
            <?php
                if(isset($_SESSION["utilizador"]))
                {
                    ...
                    while($row = mysqli_fetch_array($retval))
                    {
                        ...
                        //ALTERAR MARCACAO
                        echo "<td><a href='./alterar_marcacao.php?'><img src='editar.png' width=25 height=25></a></td>";  

                        //APAGAR MARCACAO
                        echo "<td><a href='./apagar_marcacao.php?idMarcacao=".$row["nome"]."'><img src='apagar.png' width=25 height=25></a></td>"; 
                        echo"</tr>";  
                    }
                    echo"</table>";
                }
